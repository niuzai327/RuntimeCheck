...
@property (nonatomic, strong) NSMutableArray *visibleCells; //可见cell数组
@property (nonatomic, strong) NSMutableSet *reusableCells;  //缓存池
@property (nonatomic, strong) NSMutableArray  *visibleIndexPaths;   //记录每个可见cell的indexPath的顺序
